...
async def run_test():
    ...
    try:
        ...
        # -> Fill 'invalid@example.com' into the E-mail field, fill 'wrongpassword' into the Senha (password) field, then click the 'Entrar na Plataforma' button to submit the form.
