...
async def run_test():
    ...
    try:
        ...
        # -> Fill 'admin@eskill.com.br' into the E-mail field and the given password into the Senha field, then click the 'Entrar na Plataforma' button.
        ...
        # -> Click the 'Raio X da Conta' navigation item in the left sidebar to open the financial/reporting view.
